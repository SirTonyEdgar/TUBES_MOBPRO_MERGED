...
class _HalamanRegistrasiPerusahaanState
  ...
  Future<void> handleRegistration() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (isEmailAvailable) {
        setState(() {
          emailError = null; // Reset error jika email valid
        });
        await daftarPerusahaan(email, name, companyName, phone, password);
        ...
        setState(() {
          emailError = "Email sudah digunakan"; // Set pesan error
        });
      }
    }
  }
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText: emailError, // Tampilkan pesan error di bawah field
                ),
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        if (isEmailAvailable) {
                          ...
                          setState(() {
                            emailError =
                                "Email sudah digunakan"; // Set pesan error
                          });
